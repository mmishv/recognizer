...
_lr_productions = [
  ...
  ('S -> PLUS F','S',2,'p_s_plus_f','yacc.py',95),
  ('S -> MIN F','S',2,'p_s_min_f','yacc.py',99),
  ('S -> F','S',1,'p_s_f','yacc.py',103),
  ('F -> NUMBER','F',1,'p_f_number','yacc.py',107),
  ('F -> VAR','F',1,'p_f_var','yacc.py',111),
  ('F -> P','F',1,'p_f_p','yacc.py',115),
  ('P -> OPENP ER CLOSEDP','P',3,'p_p_openp','yacc.py',119),
  ('P -> C','P',1,'p_p_c','yacc.py',123),
  ('C -> OPENCO ER CLOSEDCO','C',3,'p_c_openco','yacc.py',127),
  ('C -> B','C',1,'p_c_b','yacc.py',131),
  ('B -> OPENC ER CLOSEDC','B',3,'p_b_openc','yacc.py',135),
]
